...
bool robot_msgs__msg__motor_command_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_msgs.msg._motor_command_array.MotorCommandArray", full_classname_dest, 53) == 0);
  }
  robot_msgs__msg__MotorCommandArray * ros_message = _ros_message;
  {  // commands
    ...
    robot_msgs__msg__MotorCommand * dest = ros_message->commands.data;
...
{
  /* NOTE(esteve): Call constructor of MotorCommandArray */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_msgs.msg._motor_command_array");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MotorCommandArray");
